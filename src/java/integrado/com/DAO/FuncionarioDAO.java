...
public class FuncionarioDAO {
    ...
    public void AlterarFuncionario(FuncionarioDTO objFuncionario) throws ClassNotFoundException{
       ...
       public boolean LoginFuncionario(FuncionarioDTO objFuncionario) throws ClassNotFoundException, SQLException {
        boolean rt = false;
        String sql ="SELECT COUNT(id_funcionario) FROM funcionario where nome_funcionario = ? and senha_funcionario = ? ";
        con = new ConexaoDAO().conexaoDB();
